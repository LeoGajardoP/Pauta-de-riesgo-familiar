...
window.DATOS = {
  ...
  evento: {
    ...
    hashtag: "#LeoYDani",
    codigoVestimenta: "Formal de verano · colores vivos bienvenidos", // EJEMPLO
  },
  ...
  nosotros: {
    titulo: "Leo & Dani",
    bajada: "Dos personas, un montón de veranos y una fiesta que llevamos tiempo imaginando.",
    parrafos: [
  ...
  info: [
    { emoji: "👗", titulo: "Vestimenta", texto: "EJEMPLO — Formal de verano. El jardín es de pasto y tierra: los tacos de aguja lo van a pasar mal." },
